# Multi-Agent Infrastructure Project Context

## Project Overview

**Refer to @langgraph/ as it is the single point of truth and guidance.**
...
## Qwen Added Memories
- Framework Reference Workflow: When working with open-source frameworks, always search for and follow project-specific reference material before making changes. This includes checking documentation, examples, tests, and configuration files in the project to understand the specific patterns and conventions being used, rather than relying solely on general knowledge of the framework.
